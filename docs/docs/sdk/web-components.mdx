...
export const UMDCode = () => {
  ...
  return (
    <CodeBlock title="HTML" language="html">
      {`<script src="https://cdn.jsdelivr.net/npm/livecodes@${siteConfig.customFields.sdkVersion}/web-components.js"></script>
...
Similarly, changing the `height` attribute also updates the playground height without triggering a full reload.
