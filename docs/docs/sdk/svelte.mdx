...
It has a simple [implementation](https://github.com/live-codes/livecodes/blob/develop/src/sdk/LiveCodes.svelte) which you can easily modify in case you need.
